...
const CATEGORIES = [
  { slug: "ultrasonic", title: "Ultrasonic Equipment", src: "/images/hero/laboratory-equipment.jpg", text: "Precision ultrasonic inspection tools for nondestructive testing." },
  { slug: "gas-detection", title: "Gas Detection", src: "/images/hero/laboratory-equipment.jpg", text: "Portable industrial gas detection equipment for safe operations." },
  { slug: "water-pumps", title: "Water Pumps", src: "/images/hero/laboratory-equipment.jpg", text: "Industrial pumps and flow-control equipment for mining, process, and water applications." },
  { slug: "general-machinery", title: "General Machinery", src: "/images/hero/laboratory-equipment.jpg", text: "Reliable machinery and plant equipment for demanding industrial operations." },
];
