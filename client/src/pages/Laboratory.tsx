...
const LABS = [
  { icon: HardHat, title: "Mining Laboratory Equipment", text: "Sample preparation equipment, crushers, pulverisers, assay consumables and analytical instruments.", image: "/manus-storage/mining-laboratory-equipment_3a91d621.webp" },
  { icon: Stethoscope, title: "Medical Laboratory", text: "Diagnostic analysers, microscopes, centrifuges, reagents and clinical consumables.", image: "/manus-storage/medical-laboratory_fc8b9a82.webp" },
