/* Indicative laboratory catalogue detail page: seven image-backed entries with provisional codes and descriptions. */
...
export default function LabCategory() {
  ...
  return <PageShell>
    ...
    <section className="section section-white"><div className="content-wrap">
      <div className="catalogue-topbar"><Link href="/laboratory" className="catalogue-back"><ArrowLeft size={15} /> Back to Laboratory</Link><span className="catalogue-count">{catalogue.products.length} indicative products</span></div>
      <div className="catalogue-overview"><div><span>Catalogue type</span><strong>Indicative laboratory range</strong></div><div><span>Entries shown</span><strong>{catalogue.products.length} products</strong></div><div><span>Enquiry route</span><strong>Product-specific</strong></div></div>
      <div className="catalogue-notice"><strong>Indicative catalogue.</strong> Product codes and descriptions are provisional working entries for layout review and should be replaced with the official Bridge Wax laboratory catalogue before publication.</div>
