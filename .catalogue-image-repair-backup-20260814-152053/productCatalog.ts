...
const ULTRASONIC_IMAGES = [
  "/images/products/ultrasonic/ultrasonic-01.jpg", "/images/products/ultrasonic/ultrasonic-02.jpg", "/images/products/ultrasonic/ultrasonic-03.jpg", "/images/products/ultrasonic/ultrasonic-04.jpg", "/images/products/ultrasonic/ultrasonic-05.jpg", "/images/products/ultrasonic/ultrasonic-06.jpg", "/images/products/ultrasonic/ultrasonic-07.jpg",
];
const GAS_IMAGES = [
  "/images/products/gas-detection/gas-detection-01.jpg", "/images/products/gas-detection/gas-detection-02.jpg", "/images/products/gas-detection/gas-detection-03.jpg", "/images/products/gas-detection/gas-detection-04.jpg", "/images/products/gas-detection/gas-detection-05.jpg", "/images/products/gas-detection/gas-detection-06.jpg", "/images/products/gas-detection/gas-detection-07.jpg",
];
const PUMP_IMAGES = [
  "/images/products/water-pumps/water-pump-01.webp", "/images/products/water-pumps/water-pump-02.webp", "/images/products/water-pumps/water-pump-03.webp", "/images/products/water-pumps/water-pump-04.webp", "/images/products/water-pumps/water-pump-05.webp", "/images/products/water-pumps/water-pump-06.webp", "/images/products/water-pumps/water-pump-07.webp",
];
const MACHINERY_IMAGES = [
  "/images/products/general-machinery/general-machinery-01.jpg", "/images/products/general-machinery/general-machinery-02.jpg", "/images/products/general-machinery/general-machinery-03.jpg", "/images/products/general-machinery/general-machinery-04.jpg", "/images/products/general-machinery/general-machinery-05.jpg", "/images/products/general-machinery/general-machinery-06.jpg", "/images/products/general-machinery/general-machinery-07.jpg",
];
...
export const PRODUCT_CATALOGUES: Record<string, ProductCatalogue> = {
  ...
  "water-pumps": {
    ...
    subsections: [{
      ...
      products: [
        { code: "BW-DP-001", name: "Domestic Borehole Pump", description: "Slimline submersible pump configuration for borehole and domestic groundwater transfer applications.", image: "/images/products/water-pumps/water-pump-01.webp" },
        { code: "BW-DP-002", name: "Domestic Submersible Drainage Pump", description: "Compact submersible pump for basements, sumps, pools, rainwater pits, and household drainage duties.", image: "/images/products/water-pumps/water-pump-02.webp" },
        { code: "BW-DP-003", name: "Household Pressure Booster Pump", description: "Self-priming booster configuration for improving water pressure at taps, showers, and light domestic points of use.", image: "/images/products/water-pumps/water-pump-03.webp" },
        { code: "BW-DP-004", name: "Domestic Centrifugal Pump", description: "Compact centrifugal pump for clean-water transfer, garden irrigation, and household utility systems.", image: "/images/products/water-pumps/water-pump-04.webp" },
        { code: "BW-DP-005", name: "Compact 24V Water Booster", description: "Low-voltage booster format for small water systems, solar-assisted setups, caravans, and light utility applications.", image: "/images/products/water-pumps/water-pump-05.webp" },
        { code: "BW-DP-006", name: "Domestic Transfer Pump", description: "Portable transfer pump for moving clean water between tanks, containers, gardens, and utility points.", image: "/images/products/water-pumps/water-pump-06.webp" },
        { code: "BW-DP-007", name: "Domestic Pressure Controller", description: "Automatic pressure-control accessory for pump start-stop management and stable household water delivery.", image: "/images/products/water-pumps/water-pump-07.webp" },
        { code: "BW-DP-008", name: "Automatic Garden Irrigation Pump", description: "Compact self-priming pump configuration for garden irrigation, sprinklers, and small outdoor water systems.", image: "/images/products/water-pumps/water-pump-08.webp" },
      ],
    }],
  },
  "general-machinery": {
