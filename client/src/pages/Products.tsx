...
const CATEGORIES = [
  ...
  { title: "Ultrasonic Equipment", src: "/manus-storage/product-ultrasonic-equipment_b4a7a795.webp", text: "Precision ultrasonic inspection tools for nondestructive testing." },
  { title: "Gas Detection", src: "/manus-storage/product-gas-detection_9b990148.webp", text: "Portable industrial gas detection equipment for safe operations." },
];

const SERVICES = [
  { icon: FlaskConical, title: "Laboratory Equipment & Consumables", text: "Instruments, glassware, reagents and consumables for mining, medical, water and research laboratories.", image: "/manus-storage/home-featured-laboratory-retry_027039f2.webp" },
  { icon: Gauge, title: "Industrial Testing Instruments", text: "Testing instruments, gauges, detectors and measurement solutions for plant and field use.", image: "/manus-storage/industrial-testing-equipment_24645382.webp" },
  { icon: Cog, title: "Plant Maintenance & Spares", text: "Maintenance support and genuine spares to keep production and processing plants running.", image: "/manus-storage/industrial-maintenance-retry_c097e3f3.webp" },
  { icon: Wrench, title: "Fabrication & Repairs", text: "Workshop fabrication, refurbishment and repair of industrial components and assemblies.", image: "/manus-storage/fabrication-retry_c6b327c8.webp" },
  { icon: Pipette, title: "HDPE Pipe Systems", text: "HDPE piping, fittings and jointing solutions for water, slurry and process reticulation.", image: "/manus-storage/hdpe-pipe-systems_653a8604.webp" },
