...
const LABS = [
  { slug: "mining", icon: HardHat, title: "Mining Laboratory Equipment", text: "Sample preparation equipment, crushers, pulverisers, assay consumables and analytical instruments.", image: "/images/laboratory/mining/mining-01.jpg" },
  { slug: "medical", icon: Stethoscope, title: "Medical Laboratory", text: "Diagnostic analysers, microscopes, centrifuges, reagents and clinical consumables.", image: "/images/laboratory/medical/medical-01.jpg" },
  { slug: "water", icon: Droplets, title: "Water Analysis", text: "Meters, photometers, test kits and reagents for potable, process and effluent water testing.", image: "/images/laboratory/water/water-01.jpg" },
  { slug: "analytical", icon: Microscope, title: "Analytical Equipment", text: "Chromatography systems, ICP instruments, balances and sample preparation stations.", image: "/images/laboratory/analytical/analytical-01.jpg" },
];
