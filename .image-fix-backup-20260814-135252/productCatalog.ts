...
const PUMP_IMAGES = [
  "/images/products/water-pumps/water-pump-01.jpg", "/images/products/water-pumps/water-pump-02.jpg", "/images/products/water-pumps/water-pump-03.jpg", "/images/products/water-pumps/water-pump-04.jpg", "/images/products/water-pumps/water-pump-05.jpg", "/images/products/water-pumps/water-pump-06.jpg", "/images/products/water-pumps/water-pump-07.jpg",
];
...
export const PRODUCT_CATALOGUES: Record<string, ProductCatalogue> = {
  ...
  "water-pumps": {
    ...
    subsections: [{
      ...
      products: [
        { code: "BW-DP-001", name: "Domestic Borehole Pump", description: "Slimline submersible pump configuration for borehole and domestic groundwater transfer applications.", image: "/images/products/water-pumps/water-pump-01.jpg" },
        { code: "BW-DP-002", name: "Domestic Submersible Drainage Pump", description: "Compact submersible pump for basements, sumps, pools, rainwater pits, and household drainage duties.", image: "/images/products/water-pumps/water-pump-02.jpg" },
        { code: "BW-DP-003", name: "Household Pressure Booster Pump", description: "Self-priming booster configuration for improving water pressure at taps, showers, and light domestic points of use.", image: "/images/products/water-pumps/water-pump-03.jpg" },
        { code: "BW-DP-004", name: "Domestic Centrifugal Pump", description: "Compact centrifugal pump for clean-water transfer, garden irrigation, and household utility systems.", image: "/images/products/water-pumps/water-pump-04.jpg" },
        { code: "BW-DP-005", name: "Compact 24V Water Booster", description: "Low-voltage booster format for small water systems, solar-assisted setups, caravans, and light utility applications.", image: "/images/products/water-pumps/water-pump-05.jpg" },
        { code: "BW-DP-006", name: "Domestic Transfer Pump", description: "Portable transfer pump for moving clean water between tanks, containers, gardens, and utility points.", image: "/images/products/water-pumps/water-pump-06.jpg" },
        { code: "BW-DP-007", name: "Domestic Pressure Controller", description: "Automatic pressure-control accessory for pump start-stop management and stable household water delivery.", image: "/images/products/water-pumps/water-pump-07.jpg" },
        { code: "BW-DP-008", name: "Automatic Garden Irrigation Pump", description: "Compact self-priming pump configuration for garden irrigation, sprinklers, and small outdoor water systems.", image: "/images/products/water-pumps/water-pump-08.jpg" },
      ],
    }],
  },
  "general-machinery": {
