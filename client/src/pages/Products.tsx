...
const CATEGORIES = [
  { slug: "ultrasonic", title: "Ultrasonic Equipment", src: "/images/products/ultrasonic/ultrasonic-001.webp", text: "Precision ultrasonic inspection tools for nondestructive testing." },
  { slug: "gas-detection", title: "Gas Detection", src: "/images/products/gas-detection/gas-detection-001.webp", text: "Portable industrial gas detection equipment for safe operations." },
  { slug: "water-pumps", title: "Water Pumps", src: "/images/products/water-pumps/water-pump-001.webp", text: "Industrial pumps and flow-control equipment for mining, process, and water applications." },
  { slug: "general-machinery", title: "General Machinery", src: "/images/products/general-machinery/general-machinery-001.webp", text: "Reliable machinery and plant equipment for demanding industrial operations." },
];

const SERVICES = [
  { slug: "laboratory", icon: FlaskConical, title: "Laboratory Equipment & Consumables", text: "Instruments, glassware, reagents and consumables for mining, medical, water and research laboratories.", image: "/images/services/laboratory/laboratory-01.jpg" },
  { slug: "industrial-testing", icon: Gauge, title: "Industrial Testing Instruments", text: "Testing instruments, gauges, detectors and measurement solutions for plant and field use.", image: "/images/services/testing/testing-01.jpg" },
  { slug: "maintenance", icon: Cog, title: "Plant Maintenance & Spares", text: "Maintenance support and genuine spares to keep production and processing plants running.", image: "/images/services/maintenance/maintenance-01.jpg" },
  { slug: "fabrication", icon: Wrench, title: "Fabrication & Repairs", text: "Workshop fabrication, refurbishment and repair of industrial components and assemblies.", image: "/images/services/fabrication/fabrication-01.jpg" },
  { slug: "hdpe", icon: Pipette, title: "HDPE Pipe Systems", text: "HDPE piping, fittings and jointing solutions for water, slurry and process reticulation.", image: "/images/services/hdpe/hdpe-01.jpg" },
  { slug: "pumps", icon: Factory, title: "Pumps & Valves", text: "Pumps, valves and flow-control equipment selected for mining and industrial duty.", image: "/images/services/pumps/pumps-01.jpg" },
];
